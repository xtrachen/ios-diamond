...
-(void)setNetWorkImage:(UIImageView *)imageView urlStr:(NSString *)urlStr 
{
    ...
    [UIView animateWithDuration:AnimationTime animations:^{
        ...
        //变换完动画 从网络开始加载图
        [self.mainImageView sd_setImageWithURL:[NSURL URLWithString:urlStr] placeholderImage:self.mainImageView.image  options:SDWebImageRetryFailed|SDWebImageLowPriority completed:^(UIImage * _Nullable image, NSError * _Nullable error, SDImageCacheType cacheType, NSURL * _Nullable imageURL) {
